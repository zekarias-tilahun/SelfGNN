# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms no no no


# Layer Norm
# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms no no layer
...
# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms layer layer no
...
# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms batch batch batch
...
# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms no batch layer

# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms layer no batch

# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms batch no layer

# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms layer batch no

# python src/train.py --root ../../data/SelfGNN/pyg/ --name Photo --norms batch layer no
